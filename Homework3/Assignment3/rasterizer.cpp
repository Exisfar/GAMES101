...
void rst::rasterizer::rasterize_triangle(
  ...
  /* view_pos
   * 是三角形顶点在视图空间中的位置。通过插值这些顶点位置，可以得到当前像素在视图空间中的位置，这对于光照计算非常重要，因为光照通常是在视图空间或世界空间中进行的。*/
